...
$$
\min\_{\theta}\frac{1}{2m}\Big(\sum^{m}\_{i=1}(h\_{\theta}(x^{(i)})-y^{(i)})^2\Big)+\frac{\lambda}{2m}\Big(\sum^{n}\_{j=1}\theta^2\_j\Big)
$$
...
$$
\min\_{\beta\_0,\beta} \frac{1}{N} \sum\_{i=1}^{N} w\_i l(y\_i,\beta\_0+\beta^T x\_i)
$$
...
$$
\min\_{\theta} \frac{1}{2m} \Big[\sum\_{i=1}^{m} w\_i (h_{\theta}(x\_i) - y\_i)^2\Big]  + \lambda \sum^n\_{j=1} \Big[ \frac{1}{2} (1-\alpha) \theta^2\_j + \alpha|\theta\_j|\Big]
$$
...
![plot of chunk 2015-08-08-plot-all-data1](/img/2015-08-08-plot-all-data1-1.png)
...
![plot of chunk 2015-08-08-glmnet1](/img/2015-08-08-glmnet1-1.png)
...
![plot of chunk 2015-08-08-plot-cv-fit](/img/2015-08-08-plot-cv-fit-1.png)
...
![plot of chunk 2015-08-08-glmnet2](/img/2015-08-08-glmnet2-1.png)
 
And for $\alpha = 0$.
 
![plot of chunk 2015-08-08-glmnet3](/img/2015-08-08-glmnet3-1.png)
...
![plot of chunk 2015-08-08-glmnet4](/img/2015-08-08-glmnet4-1.png)
 
Now this is looking much more promising! How does it fare on the test set?
 
![plot of chunk 2015-08-08-glmnet5](/img/2015-08-08-glmnet5-1.png)
